...
String inputFile = "Blue_red_blobs.png";               // First run will use /data/input.png, which will not be overwritten
...
int columns = 30;                              // Number of columns in the cartesian grid
